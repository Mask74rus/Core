...
public class TechnologicalOperationParameterBaseConfiguration<T> : IEntityTypeConfiguration<T>
    where T : TechnologicalOperationParameterBase
{
    public virtual void Configure(EntityTypeBuilder<T> builder)
    {
        ...
        builder.HasQueryFilter(x => EF.Property<DateTime?>(x.Parameter, "DeletedAt") == null);
    }
}